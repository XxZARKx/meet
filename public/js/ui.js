...
export const updateMicButton = (micEnable) => {
  ...
  micButtonImage.src = micEnable ? micOffImgSrc : micOnImgSrc 
}
...
export const clearMessenger = () => {
  const messagesContainer = document.getElementById('messages_container')
  messagesContainer.querySelectorAll('*').forEach(messages => messages.remove())
}
//recording
...
export const showRecordingPanel = () => {
  ...
  //hide start recording button if is active
...
export const switchRecordingButtons = (switchForResumeButtons = false) => {
  const resumeButton = document.getElementById('resume_recording_button')
  const pauseButton = document.getElementById('pause_recording_button')

  if(switchForResumeButtons){
