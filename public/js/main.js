...
strangerChatButton.addEventListener('click', () => {
    strangerUtils.getStrangersSocketIdAndConnect(constants.callType.CHAT_STRANGER)
})

const strangerVideoButton = document.getElementById('stranger_video_button')
strangerVideoButton.addEventListener('click', () => {
  strangerUtils.getStrangersSocketIdAndConnect(constants.callType.VIDEO_STRANGER)
})

// register event for allow connections for strangers
...
checkBox.addEventListener('click', () => {
  ...
  store.setAllStates('allowConnectionsFromStrangers', !checkBoxState)
...
const handleUpButton = document.getElementById('hang_up_button')
handleUpButton.addEventListener('click', () => {
