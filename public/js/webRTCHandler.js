...
export const getLocalPreview = () => {
  navigator.mediaDevices
    ...
    .then((stream) => {
      ...
      store.setAllStates('callState',constants.callState.CALL_AVAILABLE);
      store.setAllStates('localStream', stream);
    })
    .catch((err) => {
...
const createPeerConnection = () => {
  ...
  store.setAllStates('remoteStream',remoteStream);
...
export const sendPreOffer = (callType, calleePersonalCode) => {
  ...
  if (
    ...
    store.setAllStates('callState',constants.callState.CALL_UNAVAILABLE);
...
export const switchBetweenCameraAndScreenSharing = async (
  ...
  if (screenSharingActive) {
    ...
    store
      ...
      store.setAllStates('sreenSharingActive', !state.screenSharingActive);
    ...
    try {
      ...
      store.setAllStates('screenSharingStream',screenSharingStream);
...
const setIncomingCallsAvailable = () => {
  ...
  if (localStream) {
    ...
    store.setAllStates('callState',constants.callState.CALL_AVAILABLE_ONLY_CHAT);
  }
};
